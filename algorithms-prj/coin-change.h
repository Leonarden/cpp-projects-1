#ifndef COIN-CHANGE_H_INCLUDED
#define COIN-CHANGE_H_INCLUDED
...
// Driver Code
int launchCoinChangeDP()
{
	int arr[] = {1, 2, 3};
	int m = sizeof(arr)/sizeof(arr[0]);
	int n = 4;
	cout << countDP(arr, m, n);
	return 0;
}
